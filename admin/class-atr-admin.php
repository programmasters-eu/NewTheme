...
class ATR_Admin {
    ...
    public function enqueue_script_dbform( $hook ){
         ...
         */
        wp_enqueue_script( $this->theme_name, ATR_DIR_URI . 'helpers/sweetalert2/sweetalert2.all.min.js', ['jquery'], $this->version, true );
    ...
    /**
	 * Registra los menús y submenus del theme en el
