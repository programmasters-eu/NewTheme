...
/**
 * Plugins a directory helpers
 */

include_once ATR_DIR_PATH . 'helpers/categories-images/categories-images.php';

include_once ATR_DIR_PATH . 'helpers/show-id/wpsite-show-ids.php';
